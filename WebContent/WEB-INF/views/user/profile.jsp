...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form action="timkiem.htm" class="navbar-form">
              <div class="input-group no-border">
                <input type="text" value="" class="form-control" placeholder="Search...">
                <button type="submit" class="btn btn-white btn-round btn-just-icon">
                  <div class="ripple-container">
                  		<img height="41" alt="" src="resources/assets/dist/css/ionicons/png/512/search.png">
                  </div>
                </button>
              </div>
            </form>
      ...
      <div class="card" style="margin-left: 35%; width: 18rem;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="${user.nhanvien.ten}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Last Name</label>
                          <input type="text" class="form-control" value="${user.nhanvien.ho}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="${user.nhanvien.diachi}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
